...
public class TestFinalString {
    /**
     * TestFinalString是一个不可变类，因为当它构造完成之后没有办法改变它的状态
     */
        /**
        ...
        public TestFinalString(double aMass, String aName, Date aDateOfDiscovery) {
            fMass = aMass;
            fName = aName;
    ...
    public static void main(String[] args) {
        TestFinalString planet = new TestFinalString(1.0D, "earth", new Date());
